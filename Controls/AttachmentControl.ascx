<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AttachmentControl.ascx.cs" Inherits="DotNetNuke.Modules.uDebate.Controls.AttachmentControl" %>
	...
	<table id="tblAttachment" runat="server" cellpadding="0" cellspacing="0">
	   ...
	   <%-- <tr>
	    ...
	    <tr>
		   ...
		   <td>&nbsp;<asp:LinkButton ID="cmdUpload" runat="server" <%--OnClick="cmdUpload_Click"--%> CssClass="CommandButton" CausesValidation="false" /></td>
	    </tr>
	</table>
